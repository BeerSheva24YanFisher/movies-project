...
moviesRouter.get("/movie/:id", validator(schemaId, "params"), checkAuthentication(moviesPaths.GET["/movie/:id"]), expressAsyncHandler(async (req, res) => {
...
moviesRouter.get("/mostcommented", validator(schemaFilter, "body"), checkAuthentication(moviesPaths.GET["/mostcommented"]), expressAsyncHandler(async (req, res) => {
...
moviesRouter.post("/rate", validator(schemaRating, "body"), checkAuthentication(moviesPaths.POST["/rate"]), expressAsyncHandler(async (req, res) => {
